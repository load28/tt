...
`.ts`/`.tsx` consumers. Native-only features, including Organize Imports and
refactorings, remain available through capability-specific ownership. Older
TypeScript extensions without this contract can
